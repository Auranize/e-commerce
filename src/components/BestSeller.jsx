...
const BestSeller = () => {
  ...
  const handleSeeMore = () => navigate("/collection");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-12">
          <button
            ...
            className="group flex items-center gap-2 bg-amber-600 text-white px-8 py-3 rounded-full shadow-md transition-all duration-300 hover:bg-amber-700 focus:outline-none"
            disabled={loading}
          >
            <span className="font-medium">{t("best_cta")}</span>
