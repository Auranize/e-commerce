    ...
    <div className="max-w-4xl mx-auto my-12 p-8 bg-white  rounded-lg border border-gray-100">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-1 text-gray-600">
          ...
          <li>Delivering personalized shopping experiences</li>
          <li>Improving our website functionality</li>
          <li>Sending marketing and promotional communications (with your consent)</li>
          <li>Protecting against fraudulent transactions</li>
          <li>Complying with legal obligations</li>
        </ul>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">3. Disclosure of Your Information</h2>
        <p className="text-gray-600 leading-relaxed mb-3">
          Your information may be shared with the following entities:
        </p>
        <div className="pl-4 border-l-4 border-gray-100 mb-3">
          <h3 className="font-medium text-gray-700 mb-2">Service Providers</h3>
          <p className="text-gray-600 leading-relaxed">
        ...
        <div className="pl-4 border-l-4 border-gray-100">
          <h3 className="font-medium text-gray-700 mb-2">Legal Requirements</h3>
          <p className="text-gray-600 leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">4. Security of Your Information</h2>
        <p className="text-gray-600 leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">5. Cookies and Tracking Technologies</h2>
        <p className="text-gray-600 leading-relaxed">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">6. Third-Party Websites</h2>
        <p className="text-gray-600 leading-relaxed">
          Our website may contain links to third-party websites and applications that are not affiliated with us. Once you click on these links and leave our website, we no longer have control over such third-party websites and are not responsible for their privacy practices. We encourage you to review the privacy policy of every site you visit.
        </p>
      </section>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">7. Your Privacy Rights</h2>
        <p className="text-gray-600 leading-relaxed mb-3">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-3 text-gray-700">8. Changes to This Privacy Policy</h2>
        <p className="text-gray-600 leading-relaxed">
